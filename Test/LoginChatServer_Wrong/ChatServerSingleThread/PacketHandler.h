...
public:
    ...
    virtual bool Handle_EN_PACKET_CS_CHAT_REQ_LOGIN(__int64 sessionId, __int64 AccountNo, char* SessionKey) { return true; }
    virtual bool Handle_EN_PACKET_CS_CHAT_RES_LOGIN(__int64 sessionId, byte Status, char* ID, char* Nickname, __int64 AccountNo) { return true; }
    ...
    CPacketRef Make_EN_PACKET_CS_CHAT_REQ_LOGIN_Packet(T* netInterface, __int64 AccountNo, char* SessionKey);
    CPacketRef Make_EN_PACKET_CS_CHAT_RES_LOGIN_Packet(T* netInterface, byte Status, char* ID, char* Nickname, __int64 AccountNo);
...
bool PacketHandler<T>::PacketProc(T* netInterface, __int64 sessionId, CPacketRef recvPktRef)
{
    ...
    case EN_PACKET_CS_CHAT_REQ_LOGIN:
    {
        ...
        return Handle_EN_PACKET_CS_CHAT_REQ_LOGIN(sessionId, AccountNo, SessionKey);
    }
    case EN_PACKET_CS_CHAT_RES_LOGIN:
    {
        ...
        return Handle_EN_PACKET_CS_CHAT_RES_LOGIN(sessionId, Status, ID, Nickname, AccountNo);
    }
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_REQ_LOGIN_Packet(T* netInterface, __int64 AccountNo, char* SessionKey)
{
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_RES_LOGIN_Packet(T* netInterface, byte Status, char* ID, char* Nickname, __int64 AccountNo)
{
    CPacketRef pktRef = netInterface->AllocPacket();
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_REQ_SECTOR_MOVE_Packet(T* netInterface, __int64 AccountNo, WORD SectorX, WORD SectorY)
{
    CPacketRef pktRef = netInterface->AllocPacket();
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_RES_SECTOR_MOVE_Packet(T* netInterface, __int64 AccountNo, WORD SectorX, WORD SectorY)
{
    CPacketRef pktRef = netInterface->AllocPacket();
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_REQ_MESSAGE_Packet(T* netInterface, __int64 AccountNo, WORD MessageLen, char* Message)
{
    CPacketRef pktRef = netInterface->AllocPacket();
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_RES_MESSAGE_Packet(T* netInterface, __int64 AccountNo, char* ID, char* Nickname, WORD MessageLen, char* Message)
{
    CPacketRef pktRef = netInterface->AllocPacket();
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_REQ_HEARTBEAT_Packet(T* netInterface)
{
    CPacketRef pktRef = netInterface->AllocPacket();
