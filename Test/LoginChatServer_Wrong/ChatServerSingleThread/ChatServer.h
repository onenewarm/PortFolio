...
class ChatServer : public NetServer, PacketHandler<NetServer>
{
	...
	bool Handle_EN_PACKET_CS_CHAT_REQ_LOGIN(__int64 sessionId, __int64 AccountNo, char* SessionKey);
...
protected:
	bool CheckToken(LONG64 accountNo, const char* sessionKey);
	bool IsSameKey(const char* aKey, const char* bKey);
