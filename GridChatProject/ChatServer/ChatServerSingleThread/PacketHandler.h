...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_REQ_LOGIN_Packet(T* netInterface, __int64 AccountNo, char* ID, char* Nickname, char* SessionKey)
{
...
template<typename T>
CPacketRef PacketHandler<T>::Make_EN_PACKET_CS_CHAT_RES_LOGIN_Packet(T* netInterface, byte Status, __int64 AccountNo)
{
    CPacketRef pktRef = netInterface->AllocPacket();
